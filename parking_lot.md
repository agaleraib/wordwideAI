...
## Open
- [2026-04-19] Triage `fasttrade-pro` persona forward-guidance framing before re-validating structural variants. Wave 3 measured fid=0.75 fabrication_risk on this persona holds constant across variant 1 (2026-04-15 baseline) AND variant 2 (Wave 3) — variant-independent, persona-prompt-driven (salesman register: "Sell EUR/USD Into Every Bounce," "60% probability" framing Doc A doesn't assert). Independent workstream; blocks cleanly-passing fidelity exit gate on future variant validation runs. (source: Wave 3 close, 2026-04-19)
